...
const Footer = () => {
  return (
    <>
      <div id="Footer" className='flex flex-col md:flex-row items-center justify-center mt-20 text-white bg-neutral-700 min-h-[24rem] py-8'>
        <div className='w-full md:w-4/7 flex items-center justify-center p-4'>
          <div className='w-full md:w-3/4 h-auto text-gray-700 bg-[#bbbab5]  p-4 md:p-7 rounded-xl'>
            ...
            <p className='text-base md:text-xl mt-4 md:mt-8 flex items-center gap-3'><MdLocalPhone />Phone: +91 8826282528</p>
            <p className='text-base md:text-xl mt-2 flex items-center gap-3'><IoIosMail />E-mail: singhrawatpushpender4@gmail.com</p>

            <div id="contact" className='mt-8 md:mt-16 text-xl md:text-3xl flex items-center justify-center gap-4 md:gap-10'>
              <h2><a className='hover:text-zinc-900' href="https://github.com/Pushpender-001"><FaGithub /></a></h2>
              <h2><a className='hover:text-red-600' href="https://www.instagram.com/rawatshabh__01"><FaInstagram /></a></h2>
      ...
      <div className='text-white bg-neutral-700 flex items-center justify-center p-4 text-sm md:text-base text-center'><p>Copyright 2004-2025 by Pushpender Singh Rawat. All Rights Reserved. This Portfolio is Powered by Pushpender Singh Rawat.</p></div>
